...
#start of the story
  ...
  if dOW == "door": #1
    ...
    print("You can either fight the guard or run away. The choice is your's.")
    ...
    if fOR == "fight": #2
      ...
      print('You turn the other way and run as fast as you can.')
      ...
      if lOR == "LEFT": #3
        ...
        if inOIg == "ignore": #4
          ...
          print('Through you esacape cyber space you are very unhappy.')
        elif inOIg == "speak": #4
          ignore = False
          speak = True
